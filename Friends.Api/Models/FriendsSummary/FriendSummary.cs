...
public class FriendSummary
{
    ...
    [JsonPropertyName("lastlogoff")] public long? LastLogoff { get; set; }
    ...
    [JsonPropertyName("avatarmedium")] public string AvatarMedium { get; set; } = default!;

    [JsonPropertyName("avatarfull")] public string AvatarFull { get; set; } = default!;
    ...
    [JsonPropertyName("primaryclanid")] public string? PrimaryClanId { get; set; }
    ...
    [JsonPropertyName("loccityid")] public int? LocCityId { get; set; }

    [JsonPropertyName("gameid")] public string? GameId { get; set; }

    [JsonPropertyName("gameextrainfo")] public string? GameExtraInfo { get; set; }

    [JsonPropertyName("gameserverip")] public string? GameServerIp { get; set; }
